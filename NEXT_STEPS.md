# Qalqan AI — что сделать дальше (чек-лист)

Код готов и задеплоен. Ниже — ручные действия во внешних сервисах: их нельзя
автоматизировать из репозитория, нужен вход в аккаунты. Иду по порядку, отмечаю галочки.
...
1. https://console.upstash.com → Redis-база проекта.
