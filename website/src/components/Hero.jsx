...
const STATS = [
  { n: "6+", label: "Тексеру деңгейі" },
  { n: "12+", label: "Threat Intel DB" },
  { n: "97%", label: "Дәлдік" },
  ...
  return (
    <section style={{
      ...
      <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 820 }}>
        ...
        >
          Фишинг, алаяқтық, қаржылық пирамида, лицензиясыз сайттарды нақты уақытта анықтайтын{" "}
          <strong style={{ color: "#c7d2fe" }}>Chrome кеңейтімі</strong>.
          6 деңгейлі тексеру + жасанды интеллект.
        </motion.p>
